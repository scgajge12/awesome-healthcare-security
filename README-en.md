...
A lab-style walkthrough that maps each stage of a Hack The Box engagement onto a hospital, lines it up against what vendors actually sell, and closes with the products and configurations that keep turning up in real hospital engagements: [Reading a hospital through the Hack The Box playbook](docs/practice/pentest/htb-style-hospital.md).
