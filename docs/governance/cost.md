...
対策の中身は各技術ページで扱う。
ここで扱うのは、金額、期間、資金繰り、患者への影響という、経営会議の言語に翻訳する部分である。
...
**出典**：[e-Gov 法令検索](https://laws.e-gov.go.jp/law/351M50000100036)、[社会保険診療報酬支払基金 診療報酬の審査・支払業務の流れ](https://www.ssk.or.jp/smph/shinryohoshu/gyomuflow/index.html)

**分析**：この二つを合わせると、医事会計が止まった月の入金は最短でも次の締めまで先送りになる。
支出の側は、代替運用の人件費と調査費用が停止の当日から積み上がる。
経営会議で「いくらかかるか」と同時に確認する必要があるのは、「いつ現金が入らなくなるか」である。

**分析**：損益と資金繰りは、対策の優先順位を変える。
逸失利益は診療が戻れば止まるが、請求が組み立てられない期間の入金は、記録を復元して遡って請求するまで戻らない。
締めた月の医事会計データを業務ドメインから切り離して保管しておけば、電子カルテの復旧を待たずに請求だけは出せる（[連鎖するランサムウェア攻撃](../threats/actors/ransomware-chain.md#請求の側で用意しておくこと)）。

**事実**：大阪急性期・総合医療センターの調査委員会報告書は、「既存の診療報酬制度は医療が停止せず、すべてのデータが存在し続けることが前提となっている」と指摘し、サイバー攻撃による大規模システム障害を災害と同様に捉えた緊急財政出動と診療報酬の優遇措置を国に求めている。

**出典**：[大阪急性期・総合医療センター「調査委員会報告書について」](https://www.gh.opho.jp/incident/1.html)（[報告書本文（PDF）](https://www.gh.opho.jp/pdf/report_v01.pdf)）

**分析**：制度の側にこの手当てが用意されるまでは、停止した月を越す資金は各組織で確保する。
確認する先は、開設者からの繰入の可否、金融機関の一時借入枠、保険金が支払われるまでの期間の三つになる。
...
2022 年 11 月の診療実績は、新入院患者数 558 人（前年同月比 33.3%）、延入院患者数 1 万 191 人（同 52.9%）、初診患者数 465 人（同 17.9%）、延外来患者数 1 万 5744 人（同 61.6%）である。
...
**事実**：警察庁の統計では、ランサムウェア被害に関する調査費用の総額が 1000 万円以上だった組織は 46 件で、有効回答の 51.7% にあたる。
...
**事実**：Change Healthcare への攻撃について、影響を受けた個人の数は届出のたびに更新され、2025 年 7 月 31 日時点で 1 億 9270 万人となった。
2024 年 7 月の当初の届出は 500 人であり、2025 年 1 月に約 1 億 3000 万人へ更新されている。
...
5. 各シナリオで、請求が出せない月が何か月分になるかを数え、入金が止まる時期を月単位で置く
6. 前提（どの範囲が停止するか、バックアップから戻せるか、応援を得られるか）を明示する
...
- [ ] 締めた月の医事会計データを、業務ドメインの外に保管しているかを確認した
...
- [連鎖するランサムウェア攻撃](../threats/actors/ransomware-chain.md)：診療報酬の請求サイクルが恐喝の材料になる仕組み
