...
- [経営層の責任の明確化](executive-accountability.md)：制度が名指しする経営層の行為、医療機関での責任の分かれ方、宣言を反証する測り方
- [調査データから読む、備えの穴](readiness-gaps.md)
- [インシデントの費用と、経営層への説明](cost.md)：費用の六区分、公表された実額、検証結果を経営指標へ翻訳する
- [サイバー保険とリスクの移転](insurance.md)：移せる範囲と残る範囲、補償額の置き方、約款で確認する論点
- [小規模組織で何から始めるか](small-organizations.md)：診療所、歯科、薬局、訪問看護。専任者がいない前提での着手順序
