...
| [Archimedes Center for Health Care and Medical Device Cybersecurity](https://secure-medicine.org/) | 米国 | 医療機器セキュリティの研究と、業界向けトレーニングを行う |
...
| [Health-ISAC](https://health-isac.org/) | 国際 | 医療分野の国際的な情報共有組織 |
...
| 名称 | 概要 |
|---|---|
| [Biohacking Village](biohacking-village.md) | DEF CON 内の医療, バイオセキュリティコミュニティ。実機の医療機器を対象にした Device Lab が開催される（[公式サイト](https://villageb.io/)） |
...
個別のページとして、[Biohacking Village（DEF CON）](biohacking-village.md)にまとめている。
