...
- 医療機器の脆弱性は、修正の配布に薬事上の手続きが伴うため、一般的なソフトウェアより開示までの期間が長くなる（[医療機器の検証手法](../../technology/medical-devices/testing-methodology.md)）。
...
- [IoMT（医療 IoT 機器）のリスク](../../technology/medical-devices/iomt.md)
