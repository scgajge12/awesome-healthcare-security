...
**医事会計システム**：診療内容を診療報酬の点数に変換し、患者への請求とレセプトの作成を担うシステム。レセプトコンピュータ（レセコン）とも呼ぶ。電子カルテと同時に停止すると、診療を続けていても請求ができない状態になる。

**レセプト**：診療報酬明細書。医療機関が保険者に診療費を請求するための書類。1 か月分を診療月の翌月 10 日までに審査支払機関（社会保険診療報酬支払基金、国民健康保険団体連合会）へ提出する。支払基金からの振込は診療月の翌々月の原則 21 日までとされている（[請求命令 第 2 条第 1 項](https://laws.e-gov.go.jp/law/351M50000100036)、[支払基金 審査・支払業務の流れ](https://www.ssk.or.jp/smph/shinryohoshu/gyomuflow/index.html)）。
