...
**事実**：医療は、2005 年 12 月 13 日に情報セキュリティ政策会議が決定した「重要インフラの情報セキュリティ対策に係る行動計画」の時点で、対象 10 分野（情報通信、金融、航空、鉄道、電力、ガス、政府・行政サービス、医療、水道、物流）の一つに挙げられている（[第 1 次行動計画（PDF）](https://www.cyber.go.jp/pdf/policy/infra/infra_rt.pdf)）。

**事実**：現行の「重要インフラのサイバーセキュリティに係る行動計画」（2022 年 6 月 17 日 サイバーセキュリティ戦略本部決定）は、重要インフラ分野として、情報通信、金融、航空、空港、鉄道、電力、ガス、政府・行政サービス（地方公共団体を含む）、医療、水道、物流、化学、クレジット、石油、港湾の 15 分野を特定している。
医療の重要インフラ所管省庁は厚生労働省である（[国家サイバー統括室 重要インフラ対策関連](https://www.cyber.go.jp/policy/group/infra/policy.html)）。

**事実**：2026 年 7 月 31 日に、サイバーセキュリティ戦略本部が「重要インフラのサイバーセキュリティ対策のための統一基準」を決定し、あわせて行動計画を改定した。
どちらも対象を上記 15 分野に郵便を加えた 16 分野とし、施行日を令和 8 年（2026 年）10 月 1 日と定めている（[統一基準（PDF）](https://www.cyber.go.jp/pdf/policy/infra/jyuhurakijun_2026.pdf) 1.2、[行動計画（PDF）](https://www.cyber.go.jp/pdf/policy/infra/koudoukeikaku_2026.pdf) 附則）。
あわせて「重要インフラのサイバーセキュリティに係る安全基準等策定指針」の廃止が予定されている（[国家サイバー統括室 重要インフラ対策関連](https://www.cyber.go.jp/policy/group/infra/policy.html)）。
統一基準の詳細は[経営層に問われる責任](../governance/executive-accountability.md#統一基準とその下のガイドライン案)で扱う。

**分析**：ガイドライン第 7.0 版が整合を図った相手は、この廃止が予定されている策定指針である（[前述](#医療情報システムの安全管理に関するガイドライン)）。
第 7.0 版の記述がただちに無効になるわけではないが、次の改定で参照先が統一基準と、その下で作られる安全基準等に移ることは織り込んでおく必要がある。

**分析**：2026 年に医療で動いたのは、重要インフラ分野への追加ではない。
ガイドライン第 7.0 版の根拠法にサイバーセキュリティ基本法が加わったこと、経済安全保障推進法の基幹インフラ制度に医療分野が加わったこと、重要インフラ向けの統一基準が決まったことの三つである。
三つは根拠法も対象も効き方も違う。

| 枠組み | 根拠 | 対象 | 医療機関への効き方 |
|---|---|---|---|
| 重要インフラの行動計画、統一基準 | サイバーセキュリティ基本法 | 重要インフラ 15 分野（2026 年 10 月 1 日以降は 16 分野） | 所管省庁（厚生労働省）と業界団体が作る安全基準等を通じて間接的に届く（[経営層の責任](../governance/executive-accountability.md)） |
| 基幹インフラ制度 | 経済安全保障推進法 | 指定された特定社会基盤事業者 | 指定を受けた場合に、設備の導入と維持管理の委託が事前届出と審査の対象になる（後述） |
| 医療情報システムの安全管理に関するガイドライン | 医療法施行規則 | 病院、診療所、助産所の管理者 | 立入検査で確認される義務として、全施設に直接届く（[前述](#医療情報システムの安全管理に関するガイドライン)） |

**分析**：日付だけを並べると、この三つが一つの変化に見える。
分野の数も紛らわしい。
重要インフラの 15 分野と、基幹インフラ制度が医療を加える前の 15 分野は、たまたま数が一致しているだけの別の一覧である。
自組織に何が求められるかは、どの枠組みの対象になっているかで決まるため、対象、要求、適用の時点を枠組みごとに確かめる必要がある。
