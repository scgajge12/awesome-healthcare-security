...
工程の順序に、当事者を重ねると、受け持ちが移る位置が見える。

<img src="../../../assets/psirt-handoff.svg" alt="脆弱性の受付から公表までを、報告者、メーカーの PSIRT、規制当局と情報共有組織、医療機関の四つのレーンで示す図。影響判定から通知までの区間が修正の届かない期間にあたり、この間はメーカーの回避策の提示、医療機関の到達経路の遮断と運用変更、規制当局と情報共有組織の注意喚起の配信が並行することを示す" width="100%">
