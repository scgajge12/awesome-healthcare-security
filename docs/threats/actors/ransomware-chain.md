...
| [市立奈良病院](../incidents/japan/2026-timeline.md#JP-2026-03) | 2026-04-21 | 該当しない | 当事者公表 |
...
後の 2 件はいずれも 25 日から翌月 5 日の期間に発生しており、含めれば 12 件中 7 件になる。

**分析**：10 件のうち、25 日から翌月 5 日までに発生したものは 5 件である。
この期間は 1 年 365 日のうち 137 日、割合にして 37.5% を占める。
発生の時期が請求サイクルと無関係だとすると、10 件のうちこの期間に入る件数の期待値は 3.8 件であり、5 件以上になる確率はおよそ 3 割である。
観測された 5 件は仮説の向きと矛盾しないが、偶然でも十分に起こる範囲にあり、この母数では区別できない。
除いた 2 件を含めた 12 件中 7 件で数えても、偶然に起こる確率は 1 割を超える。
10 件のうち 4 件が 10 月に集まり、うち 3 件（田沢医院 10 月 27 日、半田病院と大阪急性期・総合医療センター 10 月 31 日）が 10 月下旬の 5 日間に収まっている点も、同じ理由で偶然と切り分けられない。
