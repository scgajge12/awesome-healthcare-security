...
進行中の年である。
本ページの収録は 2026 年 9 月 20 日時点で当事者が公表した事案に限る。
...
| [JP-2026-17](#JP-2026-17) | 2026-09 | ロート製薬株式会社（一般用医薬品、スキンケア） | 不正アクセス | 未公表（通信販売のシステム） | なし | 公表なし（アクセス制限を実施） | 当事者公表 |

製薬企業自身の被害としては、本年 9 月時点で上記 3 件を収録している。
医薬品そのものを製造する企業は [JP-2026-17 ロート製薬](#JP-2026-17) の 1 件で、侵害されたのは製造でも研究でもなく通信販売の基盤である。
残る 2 件は創薬研究の受託と原料の流通を担う企業である。
...
### JP-2026-17 ロート製薬株式会社（2026 年 9 月）

**事実**

- 発生時期：2026 年 9 月 10 日に、通信販売で利用しているシステムで第三者による不正アクセスの可能性がある事象を確認した。9 月 11 日に第 1 報、9 月 15 日に調査状況を公表した。
- 対象組織：ロート製薬株式会社。一般用医薬品とスキンケア製品を製造し、自社の通信販売でも販売している。
- 攻撃種別：不正アクセス。当事者は、データが不正に取得された可能性があるとしている。
- 攻撃グループ：当事者は公表していない。
- 初期侵入経路：未公表。侵害されたのは通信販売に関わるシステムである。
- 侵害範囲：通信販売の顧客対応に用いるシステムと、顧客管理システム。
- 情報流出：顧客対応システムに保存された顧客との**通話音声データ**とこれに付随する情報が、不正に取得された可能性がある。顧客管理システムについても、情報が取得された可能性があるとしている。件数、対象となる顧客、個別の影響は調査中である。
- 診療への影響：なし。医薬品の製造と供給に関する支障は公表されていない。
- 初動対応：アクセス制限を含む措置を実施した。個人情報保護委員会へ報告し、警察および関係機関と連携している。外部の専門機関の協力を得て調査を進めている。
- 利用者への注意喚起：同社をかたる不審な連絡に対して、決済情報や認証情報を渡さないよう呼びかけている。

**報道ベース**

- サイバー犯罪フォーラムに、約 4TB のデータを取得したとする投稿があり、サンプルが公開されたと報じられている。当事者はデータ量も攻撃者も公表していない。

**分析**

- 侵害されたのは創薬の研究環境でも製造の制御系でもなく、消費者向けの通信販売である。一般用医薬品とスキンケアを消費者へ直接売る製薬企業は、医療機関を相手にする企業とは別の攻撃面を持つ。EC と顧客対応の基盤は、業種の区別なく狙われる層にある（[医療系 Web アプリケーションのセキュリティ](../../../technology/web-security/)）。
- 持ち出された可能性があるのは通話音声である。一般用医薬品の問い合わせでは、購入者が症状、服用中の薬、体質を口頭で話す。テキストの顧客名簿より粒度が高く、要配慮個人情報に当たる内容を含みうる。音声は文字として検索できないため、保有していること自体が棚卸しから漏れやすい（[ログと監視の設計](../../../technology/logging.md)）。
- 通話録音は、応対品質の確認と苦情対応のために残される。診療録のように保存期間が法令で定まっているわけではないため、消さないまま積み上がる。保存期間を決めていない記録は、侵害時に対象範囲を確定できない要因になる（[記憶媒体の廃棄と機器の下取り](../../../technology/media-disposal.md)）。
- 同社は本年 3 月にも、運営を終了したブランドサイトのドメインが第三者に取得された事案を公表している（JP-2026-S12）。消費者向けの資産は数が多く、事業の終了後も残る。製薬企業の攻撃面を数えるときは、製造と研究の外側にある消費者接点を対象に含める必要がある（[外部から見た自組織の攻撃面](../../../practice/attack-surface.md)）。

**一次情報**

- [当社システムにおける不正アクセスの可能性について](https://www.rohto.co.jp/news/whatsnew/2026/0911_01)（ロート製薬、2026 年 9 月 11 日）
- [当社システムにおける不正アクセスに関する調査状況について](https://www.rohto.co.jp/news/whatsnew/2026/0915_01)（ロート製薬、2026 年 9 月 15 日）
- [ロート製薬の不正アクセス、顧客との通話音声データが流出の可能性](https://www.security-next.com/190377)（Security NEXT による当事者公表の報道、2026 年 9 月 16 日）
...
| [JP-2026-S22](#JP-2026-S22) | 2026-04（2026-08 公表） | 独立行政法人医薬品医療機器総合機構（PMDA） | 医療関連事業者 | 機器、記憶媒体の紛失、盗難 | 職員が業務で使用していた USB メモリ 1 個の紛失が 4 月 16 日に判明した。審査報告書 3 品目分、機構内検討資料、薬事食品衛生審議会部会審議資料、承認書 2 品目分、対面助言関係資料といった非開示情報と、企業と機構の担当者の所属、氏名など **286 人分**の個人情報が保存されていた可能性がある。要配慮個人情報は含まれない。機構が貸与した機器で、誤ったパスワードを一定回数入力すると操作がロックされる。捜索と遺失物届の提出を行ったが発見に至っていない。各部室が管理するパスワード型 USB メモリの使用を今後禁止する | 当事者公表 |
| JP-2026-S23 | 2026 年度前期の実習（2026-08 公表） | 京都府立医科大学、同附属病院（京都市上京区） | 病院系 | 誤送付、誤公開、操作ミス | 学生が附属病院での実習の報告書を写した写真を SNS へ投稿した。大学は、患者個人を特定できる情報は写っていなかったとしたうえで、医療に従事する者として「極めて不適切」であるとし、8 月 14 日に公表した。附属病院から当該患者と家族へ説明と謝罪を行った。実習情報の取り扱いルールを見直し、学生への教育を徹底するとしている | 当事者公表 |
| JP-2026-S24 | 2026-08 公表 | 一般社団法人グランファミリア 海老名こじろう耳鼻咽喉科（神奈川県海老名市） | 病院系 | 誤送付、誤公開、操作ミス | 保管期間を過ぎて廃棄予定だった問診票を印刷用の裏紙として使用した。用紙の一部がプリンタに残ったまま通常業務へ移行し、患者へ渡す資料の裏面に別の患者の問診票の内容が記載された状態で交付された。問診票には氏名、住所、年齢、電話番号、生年月日、メールアドレス、既往歴が含まれる。公表時点で 1 名への交付を確認し、当該資料を回収した。用紙が使われていた正確な期間と対象の範囲は特定に至っていない | 当事者公表 |
...
### JP-2026-S22 独立行政法人医薬品医療機器総合機構（2026 年 4 月に判明、2026 年 8 月に公表）

**事実**

- 発生時期：紛失が判明したのは 2026 年 4 月 16 日である。2026 年 8 月 7 日に公表した。
- 対象組織：独立行政法人医薬品医療機器総合機構（PMDA）。医薬品と医療機器の審査、安全対策、健康被害救済を担う。
- 類型：機器、記憶媒体の紛失、盗難。
- 発生原因：職員が業務で使用していた USB メモリ 1 個を紛失した。機構は、当該 USB メモリに非開示情報と個人情報を保存して施設外へ持ち出すことを認めていない。
- 影響範囲：学会講演に使用した資料と関連する参照用資料が保存されていた可能性がある。参照用資料の一部に、次の非開示情報と個人情報が含まれていたことを確認している。
  - 審査報告書（3 品目分）、機構内検討資料、薬事食品衛生審議会部会審議資料
  - 承認書（2 品目分）
  - 対面助言関係資料
  - 企業および機構の担当者の所属、氏名などの個人情報 **286 人分**（要配慮個人情報は含まれない）
- 機器の保護：機構が貸与したもので、一定回数誤ったパスワードを入力すると全ての操作がロックされる。機構は第三者による不正閲覧の可能性は低いと評価している。
- 経過：関係者への事実確認、機構内と職員自宅の捜索、所管警察署への遺失物届の提出を行ったが、公表時点で発見に至っていない。外部への漏えいの事実も確認されていない。
- 通知：非開示情報が含まれる関係企業へ説明と連絡を済ませ、個人情報保護委員会へ報告した。関係する個人への通知を進めるとしている。
- 公表された対策：各部室が管理するパスワード型 USB メモリの使用を今後禁止する。全役職員へ注意喚起を行い、非開示情報の取り扱いに関する特別研修を実施する。

**分析**

- 紛失の判明が 4 月 16 日、公表が 8 月 7 日で、間が約 4 か月ある。公表文がこの間の対応として挙げているのは、関係者への事実確認、機構内と職員自宅の捜索、遺失物届の提出である。公表までに 4 か月を要した理由は示されていない。対象範囲が確定するまで公表を待つ運用は、対象者が自衛できない期間をその分だけ長くする。何をもって第 1 報を出すかを、範囲の確定とは別に決めておく必要がある。
- 失われたのは患者の診療情報ではなく、審査報告書と部会審議資料である。承認前の医薬品の審査資料は、当該企業にとっては競合に渡ると不利益になり、規制当局にとっては審査の独立性に関わる。医療分野の情報資産を「患者情報かどうか」だけで分類すると、この種の情報は保護の設計から抜け落ちる。
- 持ち出しの目的は学会講演の資料作成である。同じ構図は関西医科大学附属病院（JP-2026-S03）にも現れている。院内や機構内で完結する資料作成の経路を用意しない限り、禁止だけでは運用が回らない（[記憶媒体の廃棄と機器の下取り](../../../technology/media-disposal.md)）。
- 機構は同種の事案を 2017 年（治験データ 8371 件を記録した USB メモリの所在不明、JP-2017-S03）にも公表している。今回、パスワード型 USB メモリの使用そのものを禁止する対策を取った点が、前回との違いである。機器の暗号化は紛失時の閲覧を防ぐが、紛失そのものは防がない。

**一次情報**

- [業務上使用していた USB メモリの紛失について（PDF）](https://www.pmda.go.jp/about-pmda/news-release/0097.pdf)（独立行政法人医薬品医療機器総合機構、2026 年 8 月 7 日）
- [独立行政法人医薬品医療機器総合機構で使用していた USB メモリが紛失、今後は使用禁止に](https://scan.netsecurity.ne.jp/article/2026/09/01/56088.html)（ScanNetSecurity による当事者公表の報道）
...
- [当職員による SNS への不適切投稿に関するお詫びとご報告](https://web.archive.org/web/20260517184242/https://yoshino-hp.net/news/important/666/)（JP-2026-S14。芳野病院、2026 年 4 月 16 日。公表元の `yoshino-hp.net` では削除されているため保存版を参照する）
- [地方独立行政法人佐賀県医療センター好生館](https://www.koseikan.jp/information/)（JP-2026-S16。2026 年 6 月 26 日の公表。当該ページは公表時のリンクが失効しているため、お知らせ一覧を示す）
- [本学附属病院の実習における本学学生による不適切な行いに関するお詫び](https://web.archive.org/web/20260904082745/https://www.kpu-m.ac.jp/doc/news/2026/20260814.html)（JP-2026-S23。京都府立医科大学、2026 年 8 月 14 日。公表元の `www.kpu-m.ac.jp` では削除されているため保存版を参照する。報道は[学生による不適切な行い](https://scan.netsecurity.ne.jp/article/2026/09/04/56130.html)（ScanNetSecurity）にある）
- [個人情報を含む書類の不適切な取扱いに関するお詫びとお知らせ](https://ebina-kojiro.com/news/2430/)（JP-2026-S24。海老名こじろう耳鼻咽喉科、2026 年 8 月 19 日）
