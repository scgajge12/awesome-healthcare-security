...
2. 窓口が見つからない場合は、調整機関を経由する（[JPCERT/CC](https://www.jpcert.or.jp/vh/)、[IPA](https://www.ipa.go.jp/security/vuln/report/)、米国では [CISA](https://www.cisa.gov/report)）
3. 修正と公表までの猶予期間を協議する
...
| 文書 | 内容 |
|---|---|
| [OWASP Secure Medical Device Deployment Standard](https://owasp.org/www-project-secure-medical-device-deployment-standard/) | 医療機関側の導入, 運用基準 |
...
- [Biohacking Village Device Lab（DEF CON）](../labs-communities/biohacking-village.md)：メーカーが持ち込んだ実機を、研究者が合法的に検証できる
