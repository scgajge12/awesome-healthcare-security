...
- [サイバー攻撃を想定した BCP](bcp-cyber.md)：災害の BCP との違い、国が示した確認表とひな形、基盤の構えごとの書き分け、攻撃者から見た計画の弱点
- [基盤の構えと、外部への依存](dependencies.md)：可用性の責任分界、オンプレミスとシングルテナントとマルチテナント、データセンターの分散、委託先と共通基盤と AI サービスの停止
- [演習シナリオのカタログ](tabletop.md)：停止を伴う事案と伴わない事案の開始条件、注入の設計、記録と評価、頻度の決め方
