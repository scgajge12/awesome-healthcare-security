...
**事実**：国内の医療機関でも、同じ型が診療の停止として現れている。
奈良市は 2026 年 8 月 31 日、市立奈良病院で同年 4 月 21 日に起きたシステム障害の報告書を公表した。
セキュリティ監視装置のソフトウェアが自動更新されて再起動し、監視対象の端末等が 633 台から 1954 台へ増えた結果、十分に学習されていなかった院内通信が平常時のパターンからの逸脱と判定され、自動遮断が連鎖した。
救急受入が約 53 時間止まり、外来予約は約 1500 件のうち約 500 件、予定手術は 56 件のうち 18 件が延期された。
外部有識者による専門家会議は、外部からのサイバー攻撃によるものではないと結論づけている（[JP-2026-S21](../threats/incidents/japan/2026-timeline.md#JP-2026-S21)）。

**分析**：CrowdStrike の事象が端末を起動しなくしたのに対し、この事案は通信を遮断した。
どちらも更新が引き金であり、製品が想定どおりに動いた結果として業務が止まっている。
医療で効いてくるのは、遮断の判断が自動化されている点である。
専門家会議は、自動遮断を維持する場合でも、誤検知によって診療に影響が生じる可能性を考慮して適用条件を定める必要があるとしている。
自動遮断の条件、確認の手順、解除の基準を平時に決めておくかどうかで、同じ製品が防御にも停止要因にもなる。
