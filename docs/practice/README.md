...
| [診断とペネトレーションテスト](pentest/) | 医療機関と製薬企業に対する検証を、人、外部境界、Web、クラウド、内部、医療機器、製造 OT の領域に分けて整理する。演習環境の型を病院に当てはめた読み替え（[Hack The Box の型で病院を想定する](pentest/htb-style-hospital.md)）を含む |
